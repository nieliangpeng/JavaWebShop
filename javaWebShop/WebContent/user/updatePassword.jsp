			...
			<div class="right_style">
				...
				<div class="user_address_style">
					...
					<div class="Personal_info" id="Personal">
						<form action="${path_}/updatePassword.action" method="get" onsubmit="return sub();">
								...
								<ul class="xinxi">
								   ...
								   <li >
									...
									<li>
										<input type="hidden" id="truePwd" name="truePwd" value="${user.user_passwd}" /> 
										<input type="hidden" name="username" value="${user.user_username}" /> 
									</li>
								</ul>
							</form>
						<form action="${path_}/updatePhone.action" method="post" enctype="multipart/form-data">
							<ul class="Head_portrait">
								...
								<li><input type="file" name="phone"/></li>
