...
<body class="l-bg">
	<div class="login-top">
		<div class="wrapper">
			...
			<div class="fr">您好，欢迎注册一家小店账号！<a href="${path_}/jumpToIndex.action"><font color="green"><strong>首页</strong></font></a></div>
		</div>
	</div>
	<div class="l_main2">
		<div class="l_bttitle">
		...
		<div class="loginbox">
			...
			<div class="conlist">
				<div class="conbox" style="display: block; text-align: left;">
					<form name="register" action="${path_}/saveUser.action"  method="post" enctype="multipart/form-data" onsubmit="return sub();">
						<table>
							<tr>
                        ...
                        <input type="submit" id="zhuce" disabled="disabled" class="register" value="注册" />
                 </form>
				</div>
...
window.onload=function()
{
  ...
  emailElement.onblur=function()
  {
    ...
    //2.建立一个连接
    req.open("get","${pageContext.request.contextPath}/checkEmail.action?email="+email);
    //3.发送get请求
    req.send(null);
  }
//为昵称选项注册onblur事件
  nameElement.onblur=function()
  {
    ...
    //2.建立一个连接
    req.open("get","${pageContext.request.contextPath}/checkUsername.action?name="+name);
    //3.发送get请求
    req.send(null);
  }
}
